...
const CONFIG = {
  ...
  // they must be byte-identical). Deriv redirects here after login;
  // callback.html exchanges the code for a token via the backend,
  // then sends the user back to index.html.
